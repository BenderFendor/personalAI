...
class ChatBot:
    ...
    def _get_system_prompt(self) -> str:
        ...
        return (
            ...
            "- If RAG lacks info or for breaking news, then use web_search or news_search\n"
            ...
            "- use fetch_url then vector_db to check for relevant indexed content that you got from the web search\n"
